...
<head>
    ...
    <title>Solicitud Validada | Tesorería Municipal de Hermosillo</title>
                ...
                <tr>
                    <td align="center"  bgcolor="#ffffff" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                ...
                                                {{--<table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr>
                                                        <td class="center-text" align="right" height="22" style="height: 22px;">
                                                            <a href="#"  style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:12px;line-height:16px;font-style:italic;font-weight:400;color:#000000;text-decoration:none;letter-spacing:0px;">Ver este correo en su navegador</a>
                                                        </td>
                                                    </tr>
                                                </table>--}}
                                                <!-- column -->
                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <img style="width:160px;border:0px;display: inline!important;" src="{{ URL::to('/') }}/img/logo.png" width="72" border="0" alt="Tesorería Municipal de Hermosillo">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:32px;line-height:52px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">

                                    <div  >
                                    Su solicitud {{ $transaccion->Reference }} ha sido aplicado.
                                    </div>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:30px;font-weight:300;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">

                                    <div  >
                                    Su transacción {{ $transaccion->ClientReference }} se realizó con éxito.
                                    </div>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">                                                            
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.facebook.com/tesoreriahmo">
                                                                            <img style="width:36px;border:0px;display: inline!important;" src="{{ URL::to('/') }}/img/Facebook.png" width="36" border="0" alt="icon">
                                                                        </a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">                                                            
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.instagram.com/tesoreriahmo/">
                                                                            <img style="width:36px;border:0px;display: inline!important;" src="{{ URL::to('/') }}/img/Instagram.png" width="36" border="0" alt="icon">
                                                                        </a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">                                                            
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://twitter.com/tesoreriahmo">
                                                                            <img style="width:36px;border:0px;display: inline!important;" src="{{ URL::to('/') }}/img/Twitter.png" width="36" border="0" alt="icon">
                                                                        </a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <div  >
                                    Reyes y Veracruz No. 95 Col. San Benito
                                    </div>
                                </td>
                            </tr>
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <a href="tel:800 00 83707" style="color:#6e6e6e;">
                                        <span>Teléfono: 800 00 83707</span>
                                    </a>
                                </td>
                            </tr>
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <a href="https://wa.me/5216623474870" style="color:#6e6e6e;">
                                        <span>Whatsapp: 6623 47 4870</span>
                                    </a>
                                </td>
                            </tr>                            
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <a href="mailto:atencioncontribuyentes@hermosillo.gob.mx" style="color:#6e6e6e;">
                                        <span>atencioncontribuyentes@hermosillo.gob.mx</span>
                                    </a>
                                </td>
                            </tr>
                            <tr>
