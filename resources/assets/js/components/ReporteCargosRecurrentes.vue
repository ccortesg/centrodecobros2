    ...
    export default {        
        ...
        methods : {
            exportarTransacciones (){
                ...
                axios({
                    url: '/transaccionDom/exportarTransacciones?idcliente=' + me.idcliente + '&fechaInicio=' + me.fechaInicio + '&fechaFin=' + me.fechaFin,
                    meth: 'GET',
                    responseType: 'blob'
            ...
            listarTransacciones (){
                let me=this;
                var url= '/transaccionDom/reporteTransaccionesDom?idcliente=' + me.idcliente + '&fechaInicio=' + me.fechaInicio + '&fechaFin=' + me.fechaFin;
