                        ...
                        <div class="form-group row cdc-list-toolbar">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="input-group">
                                    ...
                                    <input type="date" v-model="fechaInicio" class="form-control" @change="listarRespuesta(1,buscar,criterio)">
                                    <span class="input-group-addon">Hasta</span>
                                    <input type="date" v-model="fechaFin" class="form-control" @change="listarRespuesta(1,buscar,criterio)">
                                    <button type="button" @click="listarRespuesta(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
