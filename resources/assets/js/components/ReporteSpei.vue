            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Reporte Ingresos SPEI
                    </div>
                    <!-- Listado-->
    ...
    export default {
        ...
        methods : {
            exportarTransacciones (){
                ...
                axios({
                    url: '/pagospei/exportarReporteSpei?idcliente=' + me.idcliente + '&fechaInicio=' + me.fechaInicio + '&fechaFin=' + me.fechaFin,
                    meth: 'GET',
                    responseType: 'blob'
                        ...
                        fileLink.setAttribute('download', 'reporteSpei.xlsx');
            ...
            listarTransacciones (){
                let me=this;
                var url= '/pagospei/reportePagoSpei?idcliente=' + me.idcliente + '&fechaInicio=' + me.fechaInicio + '&fechaFin=' + me.fechaFin;
